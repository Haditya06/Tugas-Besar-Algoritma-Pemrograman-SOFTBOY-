    ...
    public class Tubes {
        ...
        // --- Menu Utama Pada apk game softboy (Landing page)
        ...
        //---  Sub Menu Dalam Game Tebak Angka 1 - 100
        ...
        //--- Halaman Menu Dasboard Game setelah Landing page
        void menuGame() {
            int pilih;
            ...
            do {
                ...
                switch (pilih) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        System.out.println("Makasih Sudah Memainkan Game Kami\n");
                        break;
                    default:
        ...
        //--- Cara Main dan jalan dari game Tebak angka  
        ...
        //--- Sub menu dari game tebak angka yaitu tempat menyimpan Skor hasil dari permainan
        ...
        //--- Untuk Mencatak Meja dari Permainan Tic - Tak - Toe
        ...
        //--- Untuk Membuat game dari Tic - Tak - toe Berjalan
        ...
        //--- Buat menngatur ulang papan dari Tic - Tak - Toe sebelum dan setelah Bermain 
        ...
        //--- Cek Pemenang dari Game Tic - Tak - toe
        ...
        //Tempat penyimnan Skor untuk Game Tic - Tak - Toe
        ...
        //--- ini untuk Menyimpanan data Hasil Permainan Tic - Tak - Toe
        ...
        void registrasi() {
            ...
            if(username.isEmpty() || password.isEmpty()){
                System.out.println("Silahkan Isi Username Dan Passwordnya !!!\n");
                return;
            }
            for(user use : users){
